...
df_wea = pd.read_csv('~/Predicting-Sun-Spectra/data/input_cleaned/wea_input.csv')
print(df_wea)

df_cct = pd.read_csv('~/Predicting-Sun-Spectra/data/input_cleaned/cct_input.csv')
print(df_cct)
...
df_linreg.to_csv('~/Predicting-Sun-Spectra/data/input_cleaned/linreg.csv')
