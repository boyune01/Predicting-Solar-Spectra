"""
Module to train multilayer perceptron using scikit-learn. It takes cleaned
weather data and manipulates it in numpy arrays. Also plots the learning and
validation curves with respect to the epoch.
"""
...
def train_mlp(X, y):
    ...
    # Initialize neural network with two 64-node hidden layers and ReLU activation function
    reg = MLPRegressor(
