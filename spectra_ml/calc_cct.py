...
def calc_cct(df):
    ...
    df['cct'] = -949.86315 + (6253.80338 * np.exp(-df['n'] / 0.92159))
    + (28.70599 * np.exp(-df['n'] / 0.20039))
    + (0.00004*np.exp(-df['n'] / 0.07125))
    ...
    df1['cct'] = 36284.48953
    + (0.00228 * np.exp(-df1['n'] / 0.07861))
    + (5.4535e-36 * np.exp(-df1['n'] / 0.01543))
